...
var stripe = Stripe('pk_test_51RgpXFRkgaQO83o0xBM4TVbLnoFKpOWSRUS4s0yAGO8Lveff6kkJw1GgiwEaPLQA2n1ltk3fgqyKnV4HnqSKLV8u00x9bPKzrB');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("http://127.0.0.1:8000/bookings/checkout-session/".concat(tourId));
        case 1:
          session = _context.v;
        ...
        case 3:
          ...
          _t = _context.v;
          console.error(_t);
          (0, _alert.showAlert)("error", _t.message);
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
...
var updatePasswordSettings = document.querySelector('.form-user-password');
...
if (updateSettingsBtn) updateSettingsBtn.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (updatePasswordSettings) updatePasswordSettings.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
    var saveBtn, passwordCurrent, password, passwordConfirm;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          e.preventDefault();
